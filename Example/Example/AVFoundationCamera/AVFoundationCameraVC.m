...
#import "AVFoundationCameraVC.h"
#import <AVFoundation/AVFoundation.h>

typedef void(^PropertyChangeBlock)(AVCaptureDevice *captureDevice);

@interface AVFoundationCameraVC ()
...
@implementation AVFoundationCameraVC
...
- (void)viewDidLoad {
    ...
    [self.viewContainer.layer insertSublayer:_captureVideoPreviewLayer below:self.focusCursor.layer];
